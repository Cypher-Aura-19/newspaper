...
const Hero: React.FC<HeroProps> = ({ isDark }) => {
  return (
    <section className={`min-h-screen pt-12 ${isDark ? 'bg-gray-900' : 'bg-white'}`}>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12 masthead relative">
          ...
          <div className={`text-xs uppercase tracking-widest mb-2 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
            Est. 2022 • Islamabad Edition • Vol. III, No. 1 • {new Date().toLocaleDateString()} • Price: Free
          </div>
          <h1 className={`newspaper-headline text-7xl lg:text-9xl mb-3 tracking-tight ${isDark ? 'text-gray-100' : 'text-black'}`}>
            THE PORTFOLIO TIMES
          </h1>
          <div className={`newspaper-subhead text-xl italic ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
            "All the Code That's Fit to Print" • Daily Circulation: ∞ • Weather: Perfect for Coding
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            <div className={`retro-border mb-8 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              <div className="vintage-card-header">
                <div className="bg-red-600 text-white p-2 -m-2 mb-4">
                  <h3 className="newspaper-byline text-white text-center">🚨 BREAKING NEWS 🚨</h3>
                </div>
              </div>
              <div className="p-6">
                <div className="bg-black text-white px-3 py-1 inline-block mb-4 text-xs uppercase tracking-wide">
                  AVAILABLE FOR HIRE
                </div>
                <h4 className={`newspaper-headline text-lg mb-3 ${isDark ? 'text-gray-100' : 'text-black'}`}>
                  ENGINEER SEEKS POSITION
                </h4>
                <p className={`newspaper-body text-sm mb-4 leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                ...
                <div className={`text-xs border-t pt-2 ${isDark ? 'text-gray-400 border-gray-600' : 'text-gray-500 border-gray-300'}`}>
            ...
            <div className={`retro-border mb-8 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              <div className="vintage-card-header">
                <h4 className="newspaper-byline bg-black text-white p-2 -m-2 mb-4 text-center">CONTACT BUREAU</h4>
              </div>
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-start gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <span className={`${isDark ? 'text-gray-300' : 'text-gray-700'}`}>work.talharizwan@gmail.com</span>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-sm">
            ...
            <div className={`retro-border ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              <div className="vintage-card-header">
                <h4 className="newspaper-byline bg-black text-white p-2 -m-2 mb-4 text-center">CURRENT ASSIGNMENTS</h4>
              </div>
          ...
          <div className="lg:col-span-5">
            <div className={`retro-border ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              <div className="vintage-card-header">
                <div className="flex items-center justify-between bg-black text-white p-2 -m-2 mb-6">
                  <h2 className="newspaper-byline text-white">FRONT PAGE EXCLUSIVE</h2>
              ...
              <div className="p-8 pt-2">
                <h1 className={`newspaper-headline text-5xl lg:text-7xl mb-4 text-center leading-none ${isDark ? 'text-gray-100' : 'text-black'}`}>
                  TALHA RIZWAN
                </h1>
                <h2 className={`newspaper-subhead text-2xl mb-6 text-center italic ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Local Software Engineer Revolutionizes Digital Development
                </h2>
                
                <div className={`newspaper-byline mb-6 text-center text-xs ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                  By Staff Reporter • Technology Bureau • {new Date().toLocaleDateString()}
                </div>

                <div className="border-t-2 border-b-2 border-black my-6 py-1">
                ...
                <div className="text-center my-8">
                  <div className="inline-block border-t-2 border-b-2 border-black px-4 py-2">
                ...
                <div className="text-center">
                  <button 
                    ...
                    className="bg-black text-white px-6 py-3 border-2 border-black hover:bg-white hover:text-black transition-all duration-300 newspaper-byline tracking-wide"
                  >
          ...
          <div className="lg:col-span-3">
            <div className={`retro-border mb-8 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              <div className="vintage-card-header">
                <h4 className="newspaper-byline bg-black text-white p-2 -m-2 mb-4 text-center">TELEGRAPH LINES</h4>
              </div>
              <div className="p-6 space-y-4">
                <a 
                  ...
                  className="block border-2 border-black p-3 hover:bg-black hover:text-white transition-all duration-300"
                >
                  <div className="flex items-center gap-3">
                    <Github className="w-5 h-5" />
                    <div>
                      <div className="newspaper-byline text-sm">CODE REPOSITORY</div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="newspaper-byline text-sm">PROFESSIONAL NETWORK</div>
            ...
            <div className={`retro-border mb-8 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              <div className="vintage-card-header">
                <h4 className="newspaper-byline bg-black text-white p-2 -m-2 mb-4 text-center">WEATHER REPORT</h4>
              </div>
              <div className="p-6">
                <div className={`text-center ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  <div className="text-4xl mb-3">☀️</div>
                  <div className="newspaper-byline text-sm mb-2">ISLAMABAD</div>
                  <div className="newspaper-body text-sm mb-2">
            ...
            <div className={`retro-border ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              <div className="vintage-card-header">
                <h4 className="newspaper-byline bg-black text-white p-2 -m-2 mb-4 text-center">DAILY WISDOM</h4>
              </div>
              <div className="p-6">
                <blockquote className={`newspaper-body text-sm italic text-center leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  "The best way to predict the future is to create it."
                </blockquote>
                <div className={`text-xs text-center mt-3 border-t pt-2 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                  - Peter Drucker
                </div>
              </div>
            </div>
