...
const Hero: React.FC<HeroProps> = ({ isDark }) => {
  return (
    <section className={`min-h-screen pt-12 transition-colors duration-300 ${isDark ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="text-center mb-12 masthead relative">
          ...
          <div className={`text-xs sm:text-sm uppercase tracking-widest mb-2 px-2 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
            <span className="hidden sm:inline">Est. 2022 • Islamabad Edition • Vol. III, No. 1 • </span>
            {new Date().toLocaleDateString()} • Price: Free
          </div>
          <h1 className={`newspaper-headline text-4xl sm:text-6xl lg:text-8xl xl:text-9xl mb-3 tracking-tight px-2 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-black'}`}>
            THE PORTFOLIO TIMES
          </h1>
          <div className={`newspaper-subhead text-sm sm:text-lg lg:text-xl italic px-2 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-4 order-2 lg:order-1">
            <div className={`retro-border mb-8 transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              ...
              <div className="p-4 sm:p-6">
                ...
                <h4 className={`newspaper-headline text-base sm:text-lg mb-3 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-black'}`}>
                  ENGINEER SEEKS POSITION
                </h4>
                <p className={`newspaper-body text-xs sm:text-sm mb-4 leading-relaxed transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                ...
                <div className={`text-xs border-t-2 pt-2 transition-colors duration-300 ${
                  isDark ? 'border-gray-600 text-gray-400' : 'border-black text-gray-500'
                }`}>
            ...
            <div className={`retro-border mb-8 transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              ...
              <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
                <div className="flex items-start gap-2 sm:gap-3 text-xs sm:text-sm">
                  ...
                  <div>
                    <div className={`newspaper-byline text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>TELEPHONE</div>
                    <span className={`transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>+92 334 0500725</span>
                  </div>
                </div>
                <div className="flex items-start gap-2 sm:gap-3 text-xs sm:text-sm">
                  <Mail className="w-3 h-3" />
                  <div>
                    <div className={`newspaper-byline text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>TELEGRAPH</div>
                    <span className={`break-all transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>work.talharizwan@gmail.com</span>
                  </div>
                </div>
                <div className="flex items-start gap-2 sm:gap-3 text-xs sm:text-sm">
                  <MapPin className="w-3 h-3" />
                  <div>
                    <div className={`newspaper-byline text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>BUREAU</div>
                    <span className={`transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Islamabad, Pakistan</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Current Status */}
            <div className={`retro-border transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              <div className="vintage-card-header">
                <div className="bg-black text-white p-3 -m-3 mb-4">
                  <div className="flex items-center justify-center gap-2">
              ...
              <div className="p-4 sm:p-6 space-y-3 text-xs sm:text-sm">
                <div className={`flex items-start gap-2 sm:gap-3 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  <Briefcase className="w-3 h-3" />
                  <div>
                    <div className={`newspaper-byline text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>POSITION</div>
                ...
                <div className={`flex items-start gap-2 sm:gap-3 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  ...
                  <div>
                    <div className={`newspaper-byline text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>EDUCATION</div>
                ...
                <div className={`flex items-start gap-2 sm:gap-3 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  <span>🔬</span>
                  <div>
                    <div className={`newspaper-byline text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>RESEARCH</div>
          ...
          <div className="lg:col-span-5 order-1 lg:order-2">
            <div className={`retro-border transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
              <div className="vintage-card-header">
              ...
              <div className="p-4 sm:p-6 lg:p-8 pt-2">
                <h1 className={`newspaper-headline text-3xl sm:text-4xl lg:text-6xl xl:text-7xl mb-4 text-center leading-none transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-black'}`}>
                  TALHA RIZWAN
                </h1>
                <h2 className={`newspaper-subhead text-lg sm:text-xl lg:text-2xl mb-4 sm:mb-6 text-center italic transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Local Software Engineer Revolutionizes Digital Development
                </h2>
                
                <div className={`newspaper-byline mb-4 sm:mb-6 text-center text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                  By Staff Reporter • Technology Bureau • {new Date().toLocaleDateString()}
                </div>

                <div className={`border-t-4 border-b-4 my-4 sm:my-6 py-1 relative transition-colors duration-300 ${
                  isDark ? 'border-gray-300' : 'border-black'
                }`}>
                  <div className={`border-t border-b transition-colors duration-300 ${
                    isDark ? 'border-gray-500' : 'border-gray-400'
                  }`}></div>
                  <div className={`absolute left-0 top-0 w-4 h-full transition-colors duration-300 ${
                    isDark ? 'bg-gray-300' : 'bg-black'
                  }`}></div>
                  <div className={`absolute right-0 top-0 w-4 h-full transition-colors duration-300 ${
                    isDark ? 'bg-gray-300' : 'bg-black'
                  }`}></div>
                </div>

                <div className="hidden sm:block newspaper-columns-2">
                  <p className={`drop-cap newspaper-body mb-4 text-justify transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  ...
                  <p className={`newspaper-body mb-4 text-justify transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  ...
                  <p className={`newspaper-body mb-4 text-justify italic transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  ...
                  <p className={`newspaper-body text-justify transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                ...
                <div className="block sm:hidden space-y-4">
                  <p className={`drop-cap newspaper-body text-justify transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    ISLAMABAD - In a remarkable display of technical prowess and innovative thinking, 
                    a young software engineer has emerged as a leading figure in the digital 
                  ...
                  <p className={`newspaper-body text-justify italic transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                    "Code is not just about solving problems—it's about creating experiences 
                ...
                <div className="text-center my-6 sm:my-8">
                  <div className={`inline-block border-t-4 border-b-4 px-4 py-2 transition-colors duration-300 ${
                    isDark 
                ...
                <div className="text-center">
                  <button 
                    ...
                    className={`px-4 sm:px-6 py-2 sm:py-3 border-3 transition-all duration-300 newspaper-byline tracking-wide text-sm sm:text-base ${
                      isDark
                        ? 'bg-gray-700 text-white border-gray-300 hover:bg-gray-300 hover:text-gray-900'
          ...
          <div className="lg:col-span-3 order-3">
            <div className={`retro-border mb-8 transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              ...
              <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
                <a 
                  ...
                  className={`block border-3 p-3 transition-all duration-300 ${
                    isDark
                      ? 'border-gray-300 bg-gray-700 hover:bg-gray-300 hover:text-gray-900'
            ...
            <div className={`retro-border mb-8 transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              ...
              <div className="p-4 sm:p-6">
                <div className={`text-center transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
            ...
            <div className={`retro-border transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
              ...
              <div className="p-4 sm:p-6">
                <blockquote className={`newspaper-body text-xs sm:text-sm italic text-center leading-relaxed transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  "The best way to predict the future is to create it."
                </blockquote>
                <div className={`text-xs text-center mt-3 border-t-2 pt-2 transition-colors duration-300 ${
                  isDark ? 'border-gray-600 text-gray-400' : 'border-black text-gray-500'
                }`}>
                  - Peter Drucker
                </div>
